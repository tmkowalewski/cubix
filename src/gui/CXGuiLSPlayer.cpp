...
CXGuiLSPlayer::CXGuiLSPlayer(const TGCompositeFrame *MotherFrame, UInt_t w, UInt_t h) : TGVerticalFrame(MotherFrame, w, h, kFixedWidth)
{
    fLSPlayer = new CXLevelSchemePlayer("LS Player","LS Player");
    ...
    fListOfNucleus->Connect("TextChanged(const char *)", "CXGuiLSPlayer", this, "ManuallyAddNucleus()");
    fListOfNucleus->Connect("ReturnPressed()", "CXGuiLSPlayer", this, "CheckListOfNuclei()");
    ...
    fPlotLSButton->Connect("Clicked()", "CXGuiLSPlayer", this, "PlotLS()");
    ...
    fUseBranchingRatio->Connect("Clicked()", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    ...
    fBranchingRatio[0]->Connect("ValueSet(Long_t)", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    fBranchingRatio[1]->Connect("ValueSet(Long_t)", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    ...
    fUseELevels->Connect("Clicked()", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    ...
    fELevel[0]->Connect("ValueSet(Long_t)", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    fELevel[1]->Connect("ValueSet(Long_t)", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    ...
    fUseLifeTime->Connect("Clicked()", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    ...
    for(int i=0 ; i<2 ; i++){
        ...
        fLifeTimeScale[i]->Connect("Selected(Int_t)", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    }
    ...
    fLifeTime[0]->Connect("ValueSet(Long_t)", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    fLifeTime[1]->Connect("ValueSet(Long_t)", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    ...
    fUseSpins->Connect("Clicked()", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    ...
    fSpins[0]->Connect("ValueSet(Long_t)", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    fSpins[1]->Connect("ValueSet(Long_t)", "CXGuiLSPlayer", this, "UpdateGammaRays()");
    ...
    fGroupFrame->AddFrame(fHorizontalFrame,new TGLayoutHints(kLHintsTop | kLHintsLeft | kLHintsExpandX,0,0,5,0));
    fYrastButton->Connect("Clicked()","CXGuiLSPlayer", this, "UpdateGammaRays()");

    UpdateGammaRays();
}

CXGuiLSPlayer::~CXGuiLSPlayer()
{
    delete fLSPlayer;
}

void CXGuiLSPlayer::SetMainWindow(CXMainWindow *w)
{
    fMainWindow = w;
...
void CXGuiLSPlayer::CheckListOfNuclei()
{
...
void CXGuiLSPlayer::GetBranchingRatio(Int_t &min, Int_t &max)
{
    min = fBranchingRatio[0]->GetNumber();
    max = fBranchingRatio[1]->GetNumber();
}

void CXGuiLSPlayer::GetELevels(Float_t &min, Float_t &max)
{
    min = fELevel[0]->GetNumber();
    max = fELevel[1]->GetNumber();
}

void CXGuiLSPlayer::GetSpins(Int_t &min, Int_t &max)
{
    min = fSpins[0]->GetNumber();
    max = fSpins[1]->GetNumber();
}

void CXGuiLSPlayer::GetLifeTime(Float_t &min, Float_t &max)
{
...
void CXGuiLSPlayer::ManuallyAddNucleus()
{
    fListOfNucleus->SetTextColor(CXred);
}

void CXGuiLSPlayer::PlotLS()
{
...
void CXGuiLSPlayer::UpdateDataSet()
{

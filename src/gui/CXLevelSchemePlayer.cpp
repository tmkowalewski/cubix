...
shared_ptr<tklevel_scheme> CXLevelSchemePlayer::DrawArrows(TString ListOfNuclei,TH1 *h, TString DataSet)
{
...
shared_ptr<tklevel_scheme> CXLevelSchemePlayer::DrawArrowsForNuc(TString NucName, TString DataSet, bool do_draw)
{
...
void CXLevelSchemePlayer::DrawArrow(TH1 *hist, const std::shared_ptr<tkn::tkgammadecay> gamma, tknucleus &Nuc)
{
...
//void CXLevelSchemePlayer::GetLimits(GammaLink *link, Float_t &xmin,
...
//NuclearLevel *CXLevelSchemePlayer::GetLevel(NuclearLevel *nuclev,
//                                            LevelScheme *ls) {

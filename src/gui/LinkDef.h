...
#pragma link C++ class CXMainWindow+;
#pragma link C++ class CXCanvas+;
#pragma link C++ class CXGateBox+;
#pragma link C++ class CXRad2DPlayer+;
#pragma link C++ class CXRadCubePlayer+;
#pragma link C++ class CXRadCubeTH1Proj+;
#pragma link C++ class CXTH1Proj+;
#pragma link C++ class CXBgdUtility+;
